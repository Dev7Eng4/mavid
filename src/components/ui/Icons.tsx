...
/** Bảng / analyst — biểu đồ cột đơn giản */
export function ChartBarsIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg
      className={className}
      viewBox='0 0 24 24'
...
/** Logo YouTube — đơn giản cho ô bảng */
export function YoutubeMiniIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg className={className} viewBox='0 0 24 24' aria-hidden>
      <path
        fill='#FF0000'
        d='M23.5 6.2a3 3 0 0 0-2.1-2.1C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.4.6A3 3 0 0 0 .5 6.2 31.6 31.6 0 0 0 0 12a31.6 31.6 0 0 0 .5 5.8 3 3 0 0 0 2.1 2.1c1.9.6 9.4.6 9.4.6s7.5 0 9.4-.6a3 3 0 0 0 2.1-2.1 31.6 31.6 0 0 0 .5-5.8 31.6 31.6 0 0 0-.5-5.8z'
      />
      <path fill='#fff' d='M9.8 15.5V8.5L15.5 12 9.8 15.5z' />
    </svg>
  );
}

export function VimeoMiniIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg className={className} viewBox='0 0 24 24' aria-hidden>
      <rect width='24' height='24' rx='5' fill='#1AB7EA' />
      <path fill='#fff' d='M10 7.5 18 12 10 16.5z' />
    </svg>
  );
}

export function DailymotionMiniIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg className={className} viewBox='0 0 24 24' aria-hidden>
      <rect width='24' height='24' rx='5' fill='#0066DC' />
      <circle cx='12' cy='12' r='4' fill='#fff' />
    </svg>
  );
}

export function LinkMiniIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg
      className={className}
      viewBox='0 0 24 24'
