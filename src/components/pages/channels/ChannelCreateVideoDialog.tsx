...
export function ChannelCreateVideoDialog({ channels, onClose, onConfirm }: ChannelCreateVideoDialogProps) {
  ...
  const [maxVideosInput, setMaxVideosInput] = useState<number | null>(5);
  ...
  const handleConfirm = useCallback(async () => {
    ...
    const maxVideosPerBatch = maxVideosInput == null ? DEFAULT_MAX_VIDEOS : clampInt(maxVideosInput, 1, MAX_VIDEOS_CAP);
    ...
    try {
      ...
      setFormError(e instanceof Error ? e.message : 'Không chạy được tạo video.');
    } finally {
      setBusy(false);
    }
        ...
        <div className='grid grid-cols-1 gap-y-4 mt-4 overflow-y-auto min-h-0 flex-1 pr-1 content-start'>
          ...
          <div className='min-w-0'>
            ...
            <input
              ...
              placeholder={`Mặc định ${DEFAULT_MAX_VIDEOS}`}
