...
import { getChannelsDirPath, getListMappingPath } from '../api/urls/getListAllPaths.js';

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const DEFAULT_OUTPUT_DIR = getChannelsDirPath();
const INPUT_FILE = path.join(__dirname, '..', '..', 'input.txt');
const INDEX_FILE = getListMappingPath();
